...
async function getAboutGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/IagoWiliian');
...
Desenvolvimento back-end com Java e Spring Boot Construção de interfaces com React Manipulação de bancos de dados com MySQL e PostgreSQL Versionamento de código com Git e GitHub Fundamentos de Inteligência Artificial aplicados ao desenvolvimento Práticas de desenvolvimento utilizando Visual Studio Code Metodologias ágeis (Scrum) e trabalho em equipe
...
Busco minha primeira oportunidade como desenvolvedor Full Stack, onde eu possa aplicar meus conhecimentos, continuar evoluindo e contribuir com soluções que gerem impacto real.
                ...
                <div class="about-buttons-data">
                    <div class="buttons-container">
                        ...
                        <a href="https://docs.google.com/document/d/1GBkJ0-YyW6YjeAt07W-OleTNVYduNJLe/edit?usp=sharing&ouid=116493115445255878084&rtpof=true&sd=true" target="_blank" class="botao">Currículo</a>
                    </div>
...
async function getProjectsGithub() {
    try {
        ...
        // Não esqueça de trocar conteudoGeneration pelo seu usuário do GitHub
        const resposta = await fetch('https://api.github.com/users/IagoWiliian/repos?sort=updated&per_page=30');
...
formulario.addEventListener('submit', function (event) {
    ...
    // 👇 AGORA SIM: só bloqueia se tiver erro
    if (!isValid) {
